...
<head>
    ...
    <title>Form Tambah Data Penulis</title>
</head>
<body>
<center>
            ...
            <div class="row page-bg">
                <div class="p-4 col-md-12">
                    <div class="text-center top-icon">
                        <h3 class="mt-3">Tambah Penulis Baru</h3>
                        <br>
                        ...
                        <form id="form-login" action="{{ route('artikel.buat-data') }}" method="post">
                            ...
                            <div>
                                <input class="mt-3 form-control form-control-lg" name="nama" type="text"
                                       placeholder="Nama Penulis" autofocus required>
                            </div>
                            @error('nama')
                            ...
                            {{-- tahun terbit --}}
                             <div>
                                <input class="mt-3 form-control form-control-lg @error('jenisKelamin') is-invalid @enderror" name="jenisKelamin" type="text"
                                       placeholder="Jenis Kelamin " autofocus required>
                            </div>
                            @error('jenisKelamin')
                            <div class="alert alert-danger">
                                Jenis Kelamin Salah
                            ...
                            <div>
                                <input class="mt-3 form-control form-control-lg @error('tanggalLahir') is-invalid @enderror" name="tanggalLahir" type="text"
                                       placeholder="Tanggal Lahir" autofocus required>
                            </div>
